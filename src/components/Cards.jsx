    ...
    <div className='bg-white w-full py-[10rem] px-4'>
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
            <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
                ...
                <button className='bg-[#00df9a] rounded-md w-[200px] font-medium my-6 mx-auto py-3 text-black hover:scale-105 duration-300'>Start Trial</button>
            </div>
            <div className='w-full shadow-xl bg-gray-50 flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300'>
                ...
                <button className='text-[#00df9a] rounded-md w-[200px] font-medium my-6 mx-auto py-3 bg-black hover:scale-105 duration-300'>Start Trial</button>
            </div>
            <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
                ...
                <div className='text-center font-medium'>
                    <p className='py-2 border-b mx-8 mt-8'>3.0 TB storage</p>
